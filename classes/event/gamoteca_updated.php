 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class gamoteca_updated extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('event:gamoteca_updated', 'mod_gamoteca');
    }
    ...
    public function get_description() {
        ...
        return get_string('event:gamoteca_updated_desc', 'mod_gamoteca', $values);
    }
}
